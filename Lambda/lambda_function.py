...
def validate_data(age, dollars, intent_request):
    ...
    # Validate the amount, it should be 0 < age < 65
    if age is not None:
        age = parse_int(
            age
        ...
        if age <0 or age >65:
            return build_validation_result(
                False,
                "age",
                "The person should be older than 0 and yanger 65 ",
                
            )
        
    # Validate the age, it should be > 5000
...
def get_recommendation(riskLevel):
    """
    Returns a buying recommendation based on risk tolerance.
    """
    ...
    if riskLevel == "none" :
        ...
        recommendation = "Choose between none, low, medium, high"
